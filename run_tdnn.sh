...
stage=0  #0
nj=16
tag=<Name of experiment>    #experiment tag, so that models are not overwritten; make sure change this if running a new experiment.
expdir=exp_${tag} 
datadir=<name of data directory> #Give the absolute path in case your data directory is not present in the current working directory
train_set=<name of train directory>          #Train set Name
test_sets="DEV AND EVAL SET NAMES"        #"test_dev93 test_eval92"
#The best TRI3 MODEL
